...
function validate(options) {
    ...
    for (const pair of vpairs){
        if (options[pair.invalid]) {
            const e = "'".concat(pair.invalid, "' is not a valid configuration option. Please use '").concat(pair.expected, "' instead. This library is using Axios for requests. Please see https://github.com/axios/axios to learn more about the valid request options.");
            throw new Error(e);
        }
    }
}
     ...
     */ configure() {
        ...
        if (typeof window === 'undefined') {
            ...
            if (!opts.headers['x-goog-api-client']) {
                ...
                opts.headers['x-goog-api-client'] = "gl-node/".concat(nodeVersion);
            }
        }
        return opts;
    }
...
class OAuth2Client extends authclient_1.AuthClient {
    ...
    async getTokenAsync(options) {
        ...
        if (this.clientAuthentication === ClientAuthentication.ClientSecretBasic) {
            const basic = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from("".concat(this._clientId, ":").concat(this._clientSecret));
            headers['Authorization'] = "Basic ".concat(basic.toString('base64'));
        }
    ...
    async requestAsync(opts) {
        let reAuthRetried = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        let r2;
        try {
    ...
    async getFederatedSignonCertsAsync() {
        ...
        try {
            ...
            if (e instanceof Error) {
                e.message = "Failed to retrieve verification certificates: ".concat(e.message);
            }
            throw e;
        }
     ...
     */ async verifySignedJwtWithCertsAsync(jwt, certs, requiredAudience, issuers, maxExpiry) {
        ...
        try {
            ...
            if (err instanceof Error) {
                err.message = "Can't parse token envelope: ".concat(segments[0], "': ").concat(err.message);
            }
            throw err;
        }
        if (!envelope) {
        ...
        try {
            ...
            if (err instanceof Error) {
                err.message = "Can't parse token payload '".concat(segments[0]);
            }
            throw err;
        }
        if (!payload) {
...
class JWT extends oauth2client_1.OAuth2Client {
     ...
     */ async getRequestMetadataAsync(url) {
        ...
        if (this.subject && this.universeDomain !== authclient_1.DEFAULT_UNIVERSE) {
            throw new RangeError("Service Account user is configured for the credential. Domain-wide delegation is not supported in universes other than ".concat(authclient_1.DEFAULT_UNIVERSE));
        }
...
class Impersonated extends oauth2client_1.OAuth2Client {
     ...
     */ async sign(blobToSign) {
        ...
        const name = "projects/-/serviceAccounts/".concat(this.targetPrincipal);
        const u = "".concat(this.endpoint, "/v1/").concat(name, ":signBlob");
        const body = {
     ...
     */ async fetchIdToken(targetAudience, options) {
        ...
        await this.sourceClient.getAccessToken();
        const name = "projects/-/serviceAccounts/".concat(this.targetPrincipal);
        const u = "".concat(this.endpoint, "/v1/").concat(name, ":generateIdToken");
        const body = {
            delegates: this.delegates,
     ...
     */ constructor(options = {}){
        ...
        if (!usingExplicitUniverseDomain) {
            ...
            throw new RangeError("Universe domain ".concat(this.sourceClient.universeDomain, " in source credentials does not match ").concat(this.universeDomain, " universe domain set for impersonated credentials."));
        }
        this.endpoint = (_f = options.endpoint) !== null && _f !== void 0 ? _f : "https://iamcredentials.".concat(this.universeDomain);
    }
}
 ...
 */ class OAuthClientAuthHandler {
     ...
     */ injectAuthenticatedHeaders(opts, bearerToken) {
        ...
        if (bearerToken) {
            ...
            const base64EncodedCreds = this.crypto.encodeBase64StringUtf8("".concat(clientId, ":").concat(clientSecret));
            Object.assign(opts.headers, {
 ...
 */ function getErrorFromOAuthErrorResponse(resp, err) {
    ...
    let message = "Error code ".concat(errorCode);
 ...
 */ class BaseExternalAccountClient extends authclient_1.AuthClient {
    /** The service account email to be impersonated, if available. */ getServiceAccountEmail() {
        ...
        if (this.serviceAccountImpersonationUrl) {
            if (this.serviceAccountImpersonationUrl.length > 256) {
                 ...
                 **/ throw new RangeError("URL is too long: ".concat(this.serviceAccountImpersonationUrl));
            }
            // Parse email from URL. The formal looks as follows:
            // https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/name@project-id.iam.gserviceaccount.com:generateAccessToken
            const re = RegExp("serviceAccounts\\/(?<email>[^:]+):generateAccessToken$");
     ...
     */ async getProjectId() {
        ...
        if (this.projectId) {
            ...
            const response = await this.transporter.request({
                ...
                headers,
                url: "".concat(this.cloudResourceManagerURL.toString()).concat(projectNumber),
                responseType: 'json'
            });
    ...
    getMetricsHeaderValue() {
        ...
        return "gl-node/".concat(nodeVersion, " auth/").concat(pkg.version, " google-byoid-sdk source/").concat(credentialSourceType, " sa-impersonation/").concat(saImpersonation, " config-lifetime/").concat(this.configLifetimeRequested);
    }
    /**
     ...
     */ constructor(options, additionalOptions){
        ...
        this.cloudResourceManagerURL = new URL(opts.get('cloud_resource_manager_url') || "https://cloudresourcemanager.".concat(this.universeDomain, "/v1/projects/"));
        if (clientId) {
            this.clientAuth = {
 ...
 */ class FileSubjectTokenSupplier {
     ...
     */ async getSubjectToken(context) {
        ...
        try {
            ...
            if (err instanceof Error) {
                err.message = "The file at ".concat(parsedFilePath, " does not exist, or it is not a file. ").concat(err.message);
            }
            throw err;
        }
        let subjectToken;
     ...
     */ constructor(options, additionalOptions){
        ...
        if (subjectTokenSupplier) {
            ...
            if (formatType !== 'json' && formatType !== 'text') {
                throw new Error('Invalid credential_source format "'.concat(formatType, '"'));
            }
 ...
 */ async function generateAuthenticationHeaderMap(options) {
    ...
    const credentialScope = "".concat(dateStamp, "/").concat(options.region, "/").concat(serviceName, "/").concat(AWS_REQUEST_TYPE);
    // https://docs.aws.amazon.com/general/latest/gr/sigv4-create-string-to-sign.html
    ...
    const authorizationHeader = "".concat(AWS_ALGORITHM, " Credential=").concat(options.securityCredentials.accessKeyId, "/") + "".concat(credentialScope, ", SignedHeaders=").concat(signedHeaders, ", ") + "Signature=".concat((0, crypto_1.fromArrayBufferToHex)(signature));
    return {
 ...
 */ class ExecutableError extends Error {
    constructor(message, code){
        super("The executable failed with exit code: ".concat(code, " and error message: ").concat(message, "."));
        this.code = code;
        Object.setPrototypeOf(this, new.target.prototype);
    }
}
...
class GoogleAuth {
    ...
    getApplicationDefault() {
        let optionsOrCallback = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, callback = arguments.length > 1 ? arguments[1] : void 0;
        let options;
     ...
     */ async _tryGetApplicationCredentialsFromEnvironmentVariable(options) {
        ...
        try {
            ...
            if (e instanceof Error) {
                e.message = "Unable to read the credential file specified by the GOOGLE_APPLICATION_CREDENTIALS environment variable: ".concat(e.message);
            }
            throw e;
        }
    }
     ...
     */ fromImpersonatedJSON(json) {
        ...
        if (((_a = json.service_account_impersonation_url) === null || _a === void 0 ? void 0 : _a.length) > 256) {
             ...
             **/ throw new RangeError("Target principal is too long: ".concat(json.service_account_impersonation_url));
        }
        // Extract service account from service_account_impersonation_url
        const targetPrincipal = (_c = (_b = RegExp("(?<target>[^/]+):(generateAccessToken|generateIdToken)$").exec(json.service_account_impersonation_url)) === null || _b === void 0 ? void 0 : _b.groups) === null || _c === void 0 ? void 0 : _c.target;
        if (!targetPrincipal) {
    ...
    fromStream(inputStream) {
        let optionsOrCallback = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, callback = arguments.length > 2 ? arguments[2] : void 0;
        let options = {};
        if (typeof optionsOrCallback === 'function') {
            callback = optionsOrCallback;
        } else {
     ...
     */ async sign(data, endpoint) {
        ...
        endpoint = endpoint || "https://iamcredentials.".concat(universe, "/v1/projects/-/serviceAccounts/");
        if (client instanceof impersonated_1.Impersonated) {
    ...
    async signBlob(crypto, emailOrUniqueId, data, endpoint) {
        const url = new URL(endpoint + "".concat(emailOrUniqueId, ":signBlob"));
...
_GoogleAuth_pendingAuthClient = new WeakMap(), _GoogleAuth_instances = new WeakSet(), _GoogleAuth_prepareAndCacheClient = async function _GoogleAuth_prepareAndCacheClient(credential) {
    let quotaProjectIdOverride = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env['GOOGLE_CLOUD_QUOTA_PROJECT'] || null;
 ...
 */ class DownscopedClient extends authclient_1.AuthClient {
     ...
     */ constructor(authClient, credentialAccessBoundary, additionalOptions, quotaProjectId){
        ...
        this.stsCredential = new sts.StsCredentials("https://sts.".concat(this.universeDomain, "/v1/token"));
