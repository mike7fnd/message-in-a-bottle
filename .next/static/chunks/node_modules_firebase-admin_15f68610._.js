...
/*! firebase-admin v12.7.0 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/compiled/buffer/index.js [app-client] (ecmascript)");
"use strict";
/*!
 * @license
 * Copyright 2017 Google Inc.
    ...
    createSession(url) {
        if (!this.http2Session || this.isClosed) {
            ...
            http2Session.on('goaway', (errorCode, _, opaqueData)=>{
                throw new error_1.FirebaseAppError(error_1.AppErrorCodes.NETWORK_ERROR, "Error while making requests: GOAWAY - ".concat(opaqueData.toString(), ", Error code: ").concat(errorCode));
            });
            http2Session.on('error', (error)=>{
                throw new error_1.FirebaseAppError(error_1.AppErrorCodes.NETWORK_ERROR, "Error while making requests: ".concat(error));
            });
            return http2Session;
        }
...
/*! firebase-admin v12.7.0 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
"use strict";
/*!
 * @license
    ...
    initializeApp(options) {
        ...
        if (typeof appName !== 'string' || appName === '') {
            ...
            if (appName === DEFAULT_APP_NAME) {
                ...
                throw new error_1.FirebaseAppError(error_1.AppErrorCodes.DUPLICATE_APP, 'Firebase app named "'.concat(appName, '" already exists. This means you called initializeApp() ') + 'more than once with the same app name as the second argument. Make sure you provide a ' + 'unique name every time you call initializeApp().');
            }
        }
...
/*! firebase-admin v12.7.0 */ Object.defineProperty(exports, "__esModule", {
    value: true
});
...
/** Firebase Auth request header. */ const FIREBASE_AUTH_HEADERS = {
    ...
    'X-Goog-Api-Client': "gl-node/".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].versions.node, " fire-admin/").concat(utils.getSdkVersion())
};
...
//# sourceMappingURL=node_modules_firebase-admin_15f68610._.js.map