...
async function addMessage(content, recipient) {
    const { firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeFirebase"])(); // This should be a server-side admin instance
    ...
    // The 'public_messages' collection is now being written to from the server.
    await getFirestore().collection('public_messages').doc(messageId).set({
        ...newMessage,
...
async function getMessagesForRecipient(recipient) {
    ...
    const q = query(collection(getFirestore(), 'public_messages'), where('recipient', '==', recipient.toLowerCase().trim()));
...
async function getMessageById(id) {
    const { firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeFirebase"])();
    const docRef = doc(getFirestore(), 'public_messages', id);
...
async function getRecipients() {
    const { firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeFirebase"])();
    const querySnapshot = await getDocs(collection(getFirestore(), 'public_messages'));
    const recipientMap = new Map();
    querySnapshot.forEach((doc1)=>{
        const recipient = doc1.data().recipient;
        if (recipient) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8254d37e._.js.map