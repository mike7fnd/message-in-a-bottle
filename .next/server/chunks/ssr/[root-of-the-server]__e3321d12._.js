...
"[externals]/firebase-admin/firestore [external] (firebase-admin/firestore, cjs)", ((__turbopack_context__, module, exports) => {
...
const { serverTimestamp } = __turbopack_context__.r("[externals]/firebase-admin/firestore [external] (firebase-admin/firestore, cjs)");
...
async function getMessagesForRecipient(recipient) {
    const q = db.collection('public_messages').where('recipient', '==', recipient.toLowerCase().trim());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3321d12._.js.map